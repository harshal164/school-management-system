...
class Student(models.Model):
    ...
    _rec_name = "name"
    enrollment_no=fields.Integer(string="number")
    ...
    select=fields.Reference(selection=[("student.scholarship","scholarship"),("school.teacher","tecaher"),('school.school',"school")],string="reference" )
